    ...
    echo '<div class="jumbotron">';
		...
		echo '<div class="row">';
			...
			echo "<img src='";
				...
				if (strpos ($row['Organiser'], 'PT') !== false) { echo 'images/pt.png'; }
				if (strpos ($row['Organiser'], 'BOM') !== false) { echo 'images/bom.png'; }
				...
				if (strpos ($row['Organiser'], 'CA') !== false) { echo 'images/ca.png'; }
